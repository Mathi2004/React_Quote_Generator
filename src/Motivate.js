...
const Motivate = () => {
  ...
  const [changeColor, setChangeColor] = useState("#D8BFD8");
  ...
  return (
    ...
    <a href="https://in.linkedin.com/" target="_blank" rel="noopener noreferrer">
      <LinkedInIcon icon={LinkedInIcon} style={{marginLeft:"10px",color:"white"}} />
    </a>
                </p>
              </footer>
            </div>
              ...
              <a href="http://localhost:3000/Motivate" download>
